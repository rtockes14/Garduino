...
struct plantNumber
{
  ...
  int DayNumber;
  int mL;
  int plantState;       // 1. Dry   2. Good   3. Wet
};
...
plantNumber myPlant1 = {"1: Ivy", 3, 25, 2};
plantNumber myPlant2 = {"2: Azalea", 6, 60, 2};
...
void startCyclePassive(int counter, int counter2)
{
  u8g2_prepare();
    ...
    {
      u8g2.drawBox(91, 46 - counter2, 8, counter2);
    }
    u8g2.setFontMode(2);
    u8g2.setDrawColor(2);
